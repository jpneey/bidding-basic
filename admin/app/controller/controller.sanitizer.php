...
class Sanitizer {
    ...
    public static function url($str = '', $unique = false) {
        ...
        $friendlyURL .= ($unique) ? rand(pow(10, 5-1), pow(10, 5)-1) : '';
        return $friendlyURL;
    ...
    public static function sanitizeHTML($html) {
        ...
        if(!isset($_POST[$html]) || empty(trim($_POST[$html]))) {
            return false;
        }
        
        return addslashes($_POST[$html]);
