...
<ul class="bottom-bar white no-margin z-depth-4 hide-on-med-and-up show-on-medium-and-down row">
    ...
    <li class="col s3">
        <a href="<?php echo $BASE_DIR ?>" class="grey-text text-darken-1 block"><i class="material-icons">playlist_add</i></a>
        <p class="no-margin grey-text text-darken-1"><b>Biddings</b></p>
    </li>
    
    <li class="col s3">
        <a href="<?php echo $BASE_DIR ?>" class="grey-text text-darken-1 block"><i class="material-icons">people_outline</i></a>
        <p class="no-margin grey-text text-darken-1"><b>Suppliers</b></p>
    </li>
    
    <li class="col s3">
        <a href="<?php echo $BASE_DIR ?>" class="grey-text text-darken-1 block"><i class="material-icons">search</i></a>
