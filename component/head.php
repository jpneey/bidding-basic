...
<link href="<?= $BASE_DIR ?>static/css/materialize.css?v=beta-1" type="text/css" rel="stylesheet"/>
<link href="<?= $BASE_DIR ?>static/css/style.css?v=beta-2" type="text/css" rel="stylesheet"/>
<link href="<?= $BASE_DIR ?>static/css/search.css?v=beta-1" type="text/css" rel="stylesheet"/>
...
<script src="<?= $BASE_DIR ?>static/js/init.js?v=beta-1"></script>
